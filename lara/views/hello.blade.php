...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        <div class="login-logo">
            <a href="http://www.item.com/home"><b>Admin</b>LTE</a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg">Sign in to start your session</p>
            <form action="http://www.item.com/login" method="post">
                <input type="hidden" name="_token" value="tts3qOGrbp4llesQjHnTKUst6KAqI1No52lm4C2G">
            ...
            <div class="auth-links">
                <a href="http://www.item.com/password/reset"
                   class="text-center"
                >I forgot my password</a>
                <br>
                                    <a href="http://www.item.com/register"
                       class="text-center"
